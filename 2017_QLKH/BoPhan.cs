...
namespace _2017_QLKH
{
    public partial class BoPhan : Form
    {
        ...
        private void btn_timkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgv_BoPhan.DataSource = acc.Select_Data("SELECT BOPHAN.MABP, TENBP, BOPHAN.DIENTHOAI, TENKHO, TENNV FROM BOPHAN, NHANVIEN, KHOHANG WHERE BOPHAN.MAKHO = KHOHANG.MAKHO and BOPHAN.NQL = NHANVIEN.MANV and ( MABP like N'%" + tbx_timkiem.Text + "%' OR TENBP like N'%" + tbx_timkiem.Text + "%' OR DIENTHOAI like N'%" + tbx_timkiem.Text + "%' OR TENKHO like N'%" + tbx_timkiem.Text + "%' OR TENNV like N'%" + tbx_timkiem.Text + "%')");
                tbx_timkiem.Clear();
                dgv_BoPhan.ClearSelection();
            }
        }
        ...
        private void BoPhan_Load(object sender, EventArgs e)
        {
            ...
            dgv_BoPhan.DataSource = acc.Select_Data("SELECT BOPHAN.MABP, TENBP, BOPHAN.DIENTHOAI, TENKHO, TENNV FROM BOPHAN, NHANVIEN, KHOHANG WHERE BOPHAN.MAKHO = KHOHANG.MAKHO and BOPHAN.NQL = NHANVIEN.MANV");
