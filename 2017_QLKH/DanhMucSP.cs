...
namespace _2017_QLKH
{
    public partial class DanhMucSP : Form
    {
        ...
        private void DanhMucSP_Load(object sender, EventArgs e)
        {
            ...
            dgvDANHMUC.DataSource = acc.Select_Data("SELECT DM.MADANHMUC,TENDANHMUC,(SELECT TENKHO FROM KHOHANG WHERE MAKHO=DM.MAKHO)AS TENKHO,GHICHU from DANHMUC DM");
        ...
        private void dgvDANHMUC_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                Disable(); /*bt_them.Enabled = false; bt_xoa.Enabled = true;bt_chophepsua.Enabled = true;*/
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (key == 1)
            {
                if (tbx_tendm.Text == "" || tbx_ghichu.Text == "" || tbx_makho.Text == "")
                {
