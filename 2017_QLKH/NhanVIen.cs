...
namespace _2017_QLKH
{
    public partial class NhanVIen : Form
    {
        ...
        private void btn_timkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvNhanVien.DataSource = acc.Select_Data("Select TRANGTHAI, MANV, TENNV, EMAIL, NS, GT, NHANVIEN.DIENTHOAI, CHUCVU, HINHANH,DIACHI, LUONG, TENBP from NHANVIEN, BOPHAN WHERE BOPHAN.MABP = NHANVIEN.MABP and MANV like '%" + tbx_timkiem.Text + "%' OR TENNV like '%" + tbx_timkiem.Text + "%' OR EMAIL like '%" + tbx_timkiem.Text + "%' OR NS like '%" + tbx_timkiem.Text + "%' OR GT like N'%" + tbx_timkiem.Text + "%' OR DIENTHOAI like '%" + tbx_timkiem.Text + "%' OR CHUCVU like '%" + tbx_timkiem.Text + "%' OR DIACHI like '%" + tbx_timkiem.Text + "%' OR LUONG like '%" + tbx_timkiem.Text + "%' OR TENBP like N'%" + tbx_timkiem.Text + "%' order by MANV asc");
                tbx_timkiem.Clear();
                dgvNhanVien.ClearSelection();
            }
        }
        ...
        private void lbx_xemall_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            cbx_trangthai.Checked = false;
            ClearText();
            dgvNhanVien.DataSource = acc.Select_Data("Select NHANVIEN.TRANGTHAI, MANV, TENNV, EMAIL, NS, GT, NHANVIEN.DIENTHOAI, CHUCVU, HINHANH, DIACHI, LUONG, TENBP from NHANVIEN, BOPHAN WHERE BOPHAN.MABP = NHANVIEN.MABP order by MANV asc");
        }
        ...
        private void lbx_nvdanghi_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            keyall = 4;
            ClearText();
            dgvNhanVien.DataSource = acc.Select_Data("Select NHANVIEN.TRANGTHAI, MANV, TENNV, EMAIL, NS, GT, NHANVIEN.DIENTHOAI, CHUCVU, HINHANH, DIACHI, LUONG, TENBP from NHANVIEN, BOPHAN WHERE BOPHAN.MABP = NHANVIEN.MABP and NHANVIEN.TRANGTHAI = '0' order by MANV asc");
        }
